...
Version: 0.9.47
Resource Type: aws.cloudwatch-synthetics
---

# AWS.CLOUDWATCH-SYNTHETICS

AWS Resource Type: `aws.cloudwatch-synthetics`
...
## Available Actions
- [type: delete](#action-type: delete)
...
## Available Filters
- [State.CurrentStatus.State: FAILED](#filter-state.currentstatus.state: failed)
...
### Filter: State.CurrentStatus.State: FAILED
<a name="filter-state.currentstatus.state: failed"></a>
📌 **Description:**
...
```yaml
filters:
  - type: State.CurrentStatus.State: FAILED
```
