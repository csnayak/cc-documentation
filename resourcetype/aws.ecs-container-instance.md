...
Version: 0.9.47
Resource Type: aws.ecs-container-instance
---

# AWS.ECS-CONTAINER-INSTANCE

AWS Resource Type: `aws.ecs-container-instance`
...
- [set-state](#action-set-state)
- [tag](#action-tag)
- [update-agent](#action-update-agent)
