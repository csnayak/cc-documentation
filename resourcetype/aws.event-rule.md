---
Title: Aws.Event Rule
Category: Cloud Custodian
Last Updated: 2025-10-27
Version: 0.9.47
Resource Type: aws.event-rule
---

# AWS.EVENT-RULE

AWS Resource Type: `aws.event-rule`
...
- [set-rule-state](#action-set-rule-state)
- [tag](#action-tag)
...
- [event](#filter-event)
- [event-rule-target](#filter-event-rule-target)
- [finding](#filter-finding)
- [invalid-targets](#filter-invalid-targets)
...
### Action: set-rule-state
<a name="action-set-rule-state"></a>
📌 **Description:**
...
### Filter: event-rule-target
<a name="filter-event-rule-target"></a>
📌 **Description:**
...
<a name="filter-invalid-targets"></a>
📌 **Description:**
