...
Version: 0.9.47
Resource Type: aws.firehose
---

# AWS.FIREHOSE

AWS Resource Type: `aws.firehose`
...
- [encrypt-s3-destination](#action-encrypt-s3-destination)
...
### Action: encrypt-s3-destination
<a name="action-encrypt-s3-destination"></a>
📌 **Description:**
