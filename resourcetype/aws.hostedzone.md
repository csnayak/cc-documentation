...
AWS Resource Type: `aws.hostedzone`
...
- [set-query-logging](#action-set-query-logging)
...
- [query-logging-enabled](#filter-query-logging-enabled)
...
### Action: set-query-logging
<a name="action-set-query-logging"></a>
📌 **Description:**
...
### Filter: query-logging-enabled
<a name="filter-query-logging-enabled"></a>
📌 **Description:**
