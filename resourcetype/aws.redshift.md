...
AWS Resource Type: `aws.redshift`
...
- [enable-vpc-routing](#action-enable-vpc-routing)
...
- [set-logging](#action-set-logging)
...
### Action: enable-vpc-routing
<a name="action-enable-vpc-routing"></a>
📌 **Description:**
