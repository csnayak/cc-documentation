...
Version: 0.9.47
Resource Type: aws.route-table
---

# AWS.ROUTE-TABLE

AWS Resource Type: `aws.route-table`
...
- [cross-az-nat-gateway-route](#filter-cross-az-nat-gateway-route)
- [event](#filter-event)
...
### Filter: cross-az-nat-gateway-route
<a name="filter-cross-az-nat-gateway-route"></a>
📌 **Description:**
