...
Version: 0.9.47
Resource Type: aws.ses-configuration-set
---

# AWS.SES-CONFIGURATION-SET

AWS Resource Type: `aws.ses-configuration-set`
...
- [set-delivery-options](#action-set-delivery-options)
- [tag](#action-tag)
...
### Action: set-delivery-options
<a name="action-set-delivery-options"></a>
📌 **Description:**
