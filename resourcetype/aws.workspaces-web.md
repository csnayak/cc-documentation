---
Title: Aws.Workspaces Web
Category: Cloud Custodian
Last Updated: 2025-10-27
Version: 0.9.47
Resource Type: aws.workspaces-web
---

# AWS.WORKSPACES-WEB

AWS Resource Type: `aws.workspaces-web`
...
## Available Filters
- [browser-policy](#filter-browser-policy)
- [event](#filter-event)
...
- [user-access-logging](#filter-user-access-logging)
- [user-settings](#filter-user-settings)
- [value](#filter-value)
...
### Filter: browser-policy
<a name="filter-browser-policy"></a>
📌 **Description:**
...
### Filter: user-access-logging
<a name="filter-user-access-logging"></a>
📌 **Description:**
